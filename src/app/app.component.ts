    ...
    <div class="header-bot">
        <div class="header-bot_inner_wthreeinfo_header_mid">
            ...
            <div class="col-md-4 logo_agile">
                <h1><a href="index.html"><span>E</span>BOOn SHOP <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
            </div>
            <!-- header-bot -->
					...
					<span class="icon-bar"></span>
                        ...
                        <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav menu__list">
                                ...
                                <li class=" menu__item">
                                    <a class=" menu__link" href="mens.html">Men</a>
                                </li>


                                <li class=" menu__item">
                                    <a class=" menu__link" href="womens.html">Women </a>
    ...
    <div class="footer">
        <div class="footer_agile_inner_info_w3l">
            <div class="col-md-3 footer-left">
                <h2><a href="index.html"><span>B</span>oon Shoppy </a></h2>
            ...
            <div class="col-md-9 footer-right">
                <div class="sign-grds">
                    ...
                    <div class="col-md-5 sign-gd-two">
                        ...
                        <div class="w3-address">
                            ...
                            <div class="w3-address-grid">
                                ...
                                <div class="w3-address-right">
                                    <h6>Email Address</h6>
                                    <p>Email :<a href="mailto:example@email.com">TienDDPH08728@gmail.com</a></p>
                                </div>
                                <div class="clearfix"> </div>
                            </div>
                            <div class="w3-address-grid">
                    ...
                    <div class="col-md-3 sign-gd flickr-post">
                        ...
                        <ul>
                            <li>
                                <a href="single.html"><img src="images/t1.jpg" alt=" " class="img-responsive" /></a>
                            </li>
                            <li>
                                <a href="single.html"><img src="images/t2.jpg" alt=" " class="img-responsive" /></a>
                            </li>
                            <li>
                                <a href="single.html"><img src="images/t3.jpg" alt=" " class="img-responsive" /></a>
                            </li>
                            <li>
                                <a href="single.html"><img src="images/t4.jpg" alt=" " class="img-responsive" /></a>
                            </li>
                            <li>
                                <a href="single.html"><img src="images/t1.jpg" alt=" " class="img-responsive" /></a>
                            </li>
